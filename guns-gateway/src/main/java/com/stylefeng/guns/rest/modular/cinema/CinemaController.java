...
public class CinemaController {
    ...
    public ResponseVO getCinema(CinemaQueryVO ciemaQueryVO){
        try{
        // 按照5个条件进行筛选
            Page<CinemaVO> cinemas = cinemaServiceAPI.getCinemas(ciemaQueryVO);
              // 判断是否有满足条件的影院
    ...
    public ResponseVO getFieldInfo(Integer cinemaId,Integer fieldId){
        ...
        try{
            ...
            // 造几个销售的假数据，后续会对接订单接口
            filmFieldInfo.setSoldSeats(orderServiceAPI.getSoldSeatByFieldId(fieldId));
